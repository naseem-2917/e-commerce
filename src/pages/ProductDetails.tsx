...
export default function ProductDetails() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <Link to="/shop" className="inline-flex items-center gap-2 text-slate-500 hover:text-slate-900 mb-8 transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
                ...
                <div>
                    <div className="mb-6">
                        <span className="text-blue-600 font-semibold tracking-wider uppercase text-sm">{product.category}</span>
                        ...
                        <AnimatePresence>
                            {summary ? (
                                <motion.div
                                    ...
                                    className="bg-purple-50 p-4 rounded-xl text-sm text-purple-900 mb-4 border border-purple-100"
                                >
                    ...
                    <div className="flex items-center gap-4 mb-8">
                        <div className="flex items-center border border-slate-300 rounded-lg">
                            <button
                                ...
                                className="px-4 py-2 hover:bg-slate-50 text-slate-600 font-bold"
                            >-</button>
                            <span className="px-4 py-2 font-medium text-slate-900">{quantity}</span>
                            <button
                        ...
                        <button
                            ...
                            className="flex-1 bg-slate-900 text-white px-8 py-3 rounded-xl font-bold hover:bg-slate-800 transition-all flex items-center justify-center gap-2 shadow-lg shadow-blue-900/10"
                        >
                    ...
                    {MOCK_REVIEWS.map((review, i) => (
                        <div key={i} className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm">
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-slate-500 text-sm font-medium">Verified Buyer</span>
                            </div>
